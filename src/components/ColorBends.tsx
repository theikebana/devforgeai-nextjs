...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const rendererWithCS = renderer as THREE.WebGLRenderer & { outputColorSpace?: typeof THREE.SRGBColorSpace };
    rendererWithCS.outputColorSpace = THREE.SRGBColorSpace;
    ...
    // Scene created once; uniforms updated in separate effect below
