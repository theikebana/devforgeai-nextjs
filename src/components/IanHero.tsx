...
export default function IanHero() {
  return (
    ...
    >
      ...
      />
      <motion.div
        className="pointer-events-none absolute -bottom-1/4 -left-1/4 w-[60%] h-[80%] rounded-full bg-cyan-500/10 blur-[100px]"
      ...
      <div className="relative container p-12 mx-auto rounded-4xl bg-[#020617] border border-white/5">
        ...
        >
          <motion.div variants={heroItem} className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xs font-semibold tracking-[0.2em] text-sky-300 uppercase">
              IAN TECHNOLOGY
            </span>
          </motion.div>

          <motion.div variants={heroItem} className="space-y-5 mb-8">
            <h1 className="text-3xl md:text-[34px] lg:text-[40px] font-semibold tracking-tight text-white">
              Unified Cloud Intelligence with IAN
            </h1>
            <p className="text-sm md:text-base text-white/65 leading-relaxed max-w-3xl">
              Monitor and manage your Azure services—Virtual Machines, App
              Services, Storage Accounts, and more—from a centralized dashboard
          ...
          <div className="space-y-3">
            {heroFeatures.map((item, i) => (
              ...
              >
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-sky-400/50 bg-sky-500/20 text-sky-300">
                  ✓
                </span>
                <div>
