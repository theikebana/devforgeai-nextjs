...
import { LayoutDashboard, Brain, MessageSquare, Bell } from "lucide-react";
...
const steps = [
  {
    ...
    description:
      "Link Yelp, Facebook, Google, and Twitter so all reviews flow into one place. Automated collection keeps you on top of new feedback.",
  ...
  },
  {
    ...
    description:
      "Review Attendant classifies each review with AI-driven sentiment analysis so you see positive, neutral, and negative feedback at a glance.",
    icon: Brain,
  },
  {
    id: "03",
    ...
    description:
      "View and manage all reviews from a single portal. Real-time notifications ensure you never miss a review that needs a response.",
    icon: MessageSquare,
  },
  {
    id: "04",
    ...
    description:
      "Generate personalized responses and reply in time. Performance analytics help you track reputation and customer engagement.",
    icon: Bell,
  },
];
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            <div className="max-w-md">
              <p className="text-xs font-semibold tracking-[0.2em] text-sky-300 uppercase mb-3">
                How Review Attendant works
              </p>
              <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-white mb-3">
                From scattered reviews to one managed reputation.
              </h2>
              <p className="text-sm md:text-base text-white/65">
                Connect your review platforms, let AI classify sentiment, and
                manage responses from a unified dashboard. Real-time alerts and
                analytics keep your reputation strong.
              </p>
              ...
              <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] text-white/70 backdrop-blur-md">
                <span>Yelp · Google · Facebook · Twitter · AI responses</span>
              </div>
            </div>
              ...
              >
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-br from-sky-500/15 via-amber-500/10 to-sky-300/20" />
                      ...
                      <div className="relative mt-4 h-1 w-full rounded-full bg-white/5 overflow-hidden">
                        <motion.div
                          className="h-full rounded-full bg-gradient-to-r from-sky-400 via-amber-400/80 to-sky-300"
                          initial={{ width: "0%" }}
