...
export default function ThinkDocsHero() {
  ...
  return (
    <>
      <section className="relative overflow-hidden pt-20 pb-36 lg:pt-28 lg:pb-36 bg-[#07090E]">
        {/* Ambient glow */}
        <motion.div
        ...
        <div className="relative max-w-[1440px] p-12 mx-auto rounded-4xl bg-[#020617] border border-white/5">
          ...
          >
            ...
            <div className="space-y-5">
              <motion.div
                variants={heroItem}
                className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-sky-100/80"
              >
              ...
              >
                <Link
                  href="/book-demo"
                  className="group inline-flex items-center gap-2 rounded-xl bg-sky-500 px-5 py-3 text-sm font-medium text-black shadow-[0_0_30px_rgba(56,189,248,0.4)] hover:bg-sky-400"
                >
                  Get a live demo
                  <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" />
                </Link>

                <button className="inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm text-white/80 hover:bg-white/10">
            ...
            >
              <div className="relative rounded-2xl border border-sky-400/20 bg-gradient-to-b from-sky-500/10 to-black/80 backdrop-blur-xl p-6 min-h-[360px] pb-16 overflow-hidden">
