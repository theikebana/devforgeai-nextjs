...
const notifications = [
  {
    ...
    subtitle: "1,227 documents indexed successfully",
    time: "just now",
    count: 3,
  },
  {
    ...
    subtitle: "Research Assistant is now live",
    time: "1m 11s",
  },
  {
    id: 3,
    title: "Secure Access Verified",
    subtitle: "All enterprise policies enforced",
    time: "5m",
  },
];
...
function NotificationList() {
  return (
    <motion.div
      className="bg-black/40 backdrop-blur-md p-3 rounded-md w-full space-y-3 shadow-md"
      initial="collapsed"
      whileHover="expanded"
    >
      <div>
